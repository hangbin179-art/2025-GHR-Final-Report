...
export const COUNTRIES = [
  {
    ko: '콩고민주공화국', countryEn: 'DR Congo', chartName: 'DR Congo',
    en: 'DR Congo · S. Kivu, Tanganyika, Kasai', region: 'S. Kivu · Tanganyika · Kasai',
    activities: ['food', 'nutrition', 'livelihood'],
    projects: [
      { site: '남부키부 (South Kivu)', siteEn: 'South Kivu', title: 'DRC South Kivu Integrated Food Assistance 2025', lat: -2.50, lng: 28.90, food: 3088.2, ther: 74.9, cash: 0, val: 5050526, beneficiaries: 152882, korea: 37522, plannedTons: 3488, pbas: '223847' }, // val=결과보고 PIVOT(CSSValue); 총사업비는 FINANCE에서 재무보고 기준
      { site: '탕가니카 (Tanganyika)', siteEn: 'Tanganyika', title: 'DRC Tanganyika General Food Distribution & Nutrition 2025', lat: -6.00, lng: 29.70, food: 632.6, ther: 0, cash: 0, val: 1093743, beneficiaries: 77122, korea: 15503, plannedTons: 1549, pbas: '223796' },
  ...
  },
  {
    ...
    en: 'Sudan · S. Darfur, S. Kordofan, White Nile', region: 'S. Darfur · S. Kordofan · White Nile',
    ...
    projects: [
      ...
      { site: '남코르도판', siteEn: 'South Kordofan', title: 'South Kordofan Integrated Food Assistance Project', lat: 12.20, lng: 30.20, food: 1025.7, ther: 16.0, cash: 324429, val: 1010325, beneficiaries: 249491, korea: 27339, plannedTons: 1624, pbas: '223710' }, // val=결과보고 PIVOT(CSSValue); 정리표 운송용 재무약정값은 build-2025-actuals.mjs FIN_FOOD
      ...
      { site: '백나일 (White Nile)', siteEn: 'White Nile', title: 'White Nile Integrated Food Assistance Project', lat: 13.05, lng: 32.55, food: 0, ther: 0, cash: 0, val: 0, beneficiaries: 0, korea: 0, plannedTons: 5320, pbas: '223856', note: 'Not yet started — pending host-government approval' },
    ],
  },
  {
    ko: '아프가니스탄', countryEn: 'Afghanistan',
    en: 'Afghanistan · Ghor, Badghis', region: 'Ghor · Badghis',
    activities: ['food', 'cash', 'nutrition'],
    projects: [
  ...
  },
  {
    ...
    en: 'Ethiopia · Tigray, Afar, Amhara', region: 'Tigray · Afar · Amhara',
  ...
  },
  {
    ...
    en: 'Uganda · Bidibidi, Lobule', region: 'Bidibidi · Lobule',
    activities: ['food', 'cash', 'nutrition'],
    projects: [
  ...
  },
  {
    ...
    en: 'Venezuela · Zulia, Falcón +2', region: 'Zulia · Falcón +2',
  ...
  },
  {
    ...
    en: 'South Sudan · Fashoda, Renk, Juba', region: 'Fashoda · Renk · Juba',
    ...
    projects: [
      ...
      { site: '렌크 · 마뇨', siteEn: 'Renk · Manyo', title: 'Renk and Manyo Food Assistance Project', lat: 11.75, lng: 32.80, food: 81.2, ther: 0, cash: 0, val: 136515, beneficiaries: 43370, korea: 4620, plannedTons: 103, pbas: '223758' }, // val=결과보고 PIVOT(CSSValue); 총사업비는 FINANCE에서 재무보고 기준
  ...
  },
  {
    ...
    en: 'Chad · Farchana +5 (School feeding)', region: 'Farchana +5 · School feeding',
  ...
  },
  {
    ...
    en: "Bangladesh · Cox's Bazar (Cash)", region: "Cox's Bazar · Cash only",
    activities: ['cash'],
    projects: [
  ...
  },
  {
    ...
    en: 'Colombia · Valle del Cauca (Cash)', region: 'Valle del Cauca · Cash only',
    activities: ['cash'],
    projects: [
      { site: '바예델카우카', siteEn: 'Valle del Cauca', title: 'Valle Del Cauca Cash Transfer & Capacity Building', lat: 3.40, lng: -76.50, food: 0, ther: 0, cash: 1456689, val: 0, beneficiaries: 15635, korea: 10132, plannedTons: 0, pbas: '223799' },
    ],
  },
  {
    ko: '중앙아프리카공화국', countryEn: 'CAR', chartName: 'CAR',
    en: 'CAR · Bambari, Bouar (Livelihood)', region: 'Bambari · Bouar · Livelihood',
  ...
  },
  {
    ...
    en: 'Myanmar · Northern Shan (Emergency cash)', region: 'Northern Shan · Emergency cash',
    activities: ['cash'],
    projects: [
  ...
  },
  {
    ...
    en: 'Kenya · Makueni, Kitui', region: 'Makueni · Kitui',
    activities: ['livelihood'],
    projects: [
      { site: '마쿠에니 · 키투이 (마을저축그룹 · 작물보험)', siteEn: 'Makueni · Kitui', title: 'Sustainable Food Systems Project', lat: -1.80, lng: 37.60, food: 0, ther: 0, cash: 0, val: 0, beneficiaries: 64080, korea: 64080, plannedTons: 0, pbas: '223864', note: 'Budget for livelihood activities — savings-group operations, livestock purchase, etc.' },
    ],
  },
]
