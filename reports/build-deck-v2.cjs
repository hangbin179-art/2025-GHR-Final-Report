...
pres.title = '2025 글로벌 식량위기 대응사업 — 최종 결과보고 (v2)'
...
function footer(s, page) {
  ...
  s.addText(`${String(page).padStart(2, '0')} / 13`, { x: W - ML - 2, y: 7.11, w: 2, h: 0.28, align: 'right', fontFace: EN, fontSize: 9, bold: true, color: G6 })
}
// 가로 진행 막대(트랙 + 채움)
...
// ===================================================================
// Slide 12 — 05 GALLERY 현장의 기록 (1 + 3 에디토리얼)
// ===================================================================
{
  const s = pres.addSlide(); s.background = { color: WHITE }
...
// ---------- 저장 (원본과 다른 v2 파일명, 잠금 시 _v2b) ----------
const OUT = 'C:/dev/food-crisis-dashboard/reports/2025_글로벌식량위기대응_결과보고_v2.pptx'
